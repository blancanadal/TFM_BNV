...
set_property -dict {PACKAGE_PIN E16 IOSTANDARD LVCMOS33} [get_ports PCLK]
create_clock -period 40.000 -name pclk -waveform {0.000 20.000} -add [get_ports PCLK]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets PCLK]

set_input_delay -clock [get_clocks pclk] -max 5.0 [get_ports PCLK] # Tsetup
set_input_delay -clock [get_clocks pclk] -min 1.0 [get_ports PCLK] # Thold
...
#set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS33} [get_ports SCREEN_ON]
set_property -dict {PACKAGE_PIN L16 IOSTANDARD LVCMOS33} [get_ports SCREEN_ON]
...
set_property -dict {PACKAGE_PIN C17 IOSTANDARD LVCMOS33} [get_ports D0]
set_property -dict {PACKAGE_PIN D18 IOSTANDARD LVCMOS33} [get_ports D1]
set_property -dict {PACKAGE_PIN E18 IOSTANDARD LVCMOS33} [get_ports D2]
set_property -dict {PACKAGE_PIN G17 IOSTANDARD LVCMOS33} [get_ports D3]
set_property -dict {PACKAGE_PIN D17 IOSTANDARD LVCMOS33} [get_ports D4]
set_property -dict {PACKAGE_PIN E17 IOSTANDARD LVCMOS33} [get_ports D5]
set_property -dict {PACKAGE_PIN F18 IOSTANDARD LVCMOS33} [get_ports D6]
set_property -dict {PACKAGE_PIN G18 IOSTANDARD LVCMOS33} [get_ports D7]
...
set_property -dict {PACKAGE_PIN G16 IOSTANDARD LVCMOS33} [get_ports RESET]
set_property -dict {PACKAGE_PIN H14 IOSTANDARD LVCMOS33} [get_ports PWDN]
#set_property -dict { PACKAGE_PIN E16   IOSTANDARD LVCMOS33 } [get_ports { PCLK }]; #IO_L11N_T1_SRCC_15 Sch=jb[7]
#set_property -dict { PACKAGE_PIN F13   IOSTANDARD LVCMOS33 } [get_ports { JB[8] }]; #IO_L5P_T0_AD9P_15 Sch=jb[8]
#set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports {JB[2]}]; #IO_0_15 Sch=jb[9]
set_property -dict {PACKAGE_PIN H16 IOSTANDARD LVCMOS33} [get_ports XCLK]


##Pmod Header JC

set_property -dict {PACKAGE_PIN K1 IOSTANDARD LVCMOS33} [get_ports SIOD]
#set_property -dict {PACKAGE_PIN F6 IOSTANDARD LVCMOS33} [get_ports {JB[2]}]
set_property -dict {PACKAGE_PIN J2 IOSTANDARD LVCMOS33} [get_ports SIOC]
#set_property -dict { PACKAGE_PIN G6    IOSTANDARD LVCMOS33 } [get_ports { XCLK }]; #IO_L19P_T3_35 Sch=jc[4]
